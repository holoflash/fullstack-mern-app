const HomePage = () => (
    <div className="container home">
        <h1>Hello! 👋</h1>
        <p>This is a full-stack website I have built using the MERN stack (MongoDB, Express.js, React, and Node.js). The backend is hosted on MongoDB Atlas, and the site is deployed via <a href="https://render.com/">https://render.com</a>. I'm currently using Firebase for user authentication, and SASS for styling.</p>
        ...
        <hr></hr>
        <h4>ROADMAP:</h4>
        <p>This site was built while learning how to use the MERN stack but is quickly evolving into a real passion project. The idea is to build a platform for Spotify Playlist curators to receive song submissions in a more organic way than what is currently available online.</p>
        <details>
        ...
        <hr></hr>
        <p>Thank you so much for taking the time to check out my site. I hope you have a nice day! </p>
        <a href="https://github.com/holoflash/fullstack-mern-app">View code on GitHub</a>
    </div >
);
